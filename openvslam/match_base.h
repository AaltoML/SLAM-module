...
// Mostly from OpenVSLAM, but modified to use uint32_t arrays instead of cv::Mat
inline unsigned int compute_descriptor_distance_32(const uint32_t *desc_1, const uint32_t *desc_2) {
    ...
    const auto* pa = desc_1;
    const auto* pb = desc_2;
